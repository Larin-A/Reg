<div class="divForm">
    <form action="/editReg/serverEditReg.php" method="POST" name="%s" id="formEditReg" autocomplete="on">
        <h1>Редактирование записи</h1>
        <div class="grid-form-reg">
            <label for="login">Логин</label>
            <input type="text" name="login" id="login" placeholder="User123" value="%s" required minlength="3" maxlength="32" autocomplete="username">
            <label for="email">E-mail</label>
            <input type="email" name="email" id="email" placeholder="user123@gmail.com" value="%s" required minlength="5" maxlength="64" autocomplete="email">
            <label for="telephone">Номер телефона</label>
            <input type="text" name="telephone" id="telephone" placeholder="+7(900) 000-0000" value="%s" required autocomplete="tel">
